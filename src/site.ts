...
window.addEventListener("DOMContentLoaded", () => {
    ...
    const animateLogo = document.body.querySelector<HTMLElement>(".animate-logo");
    ...
    animateLogo.style.animationPlayState = "running";
...
function TryLoadDiscord() {
    ...
    document.body.querySelector<HTMLIFrameElement>("#discord").src
        = "https://e.widgetbot.io/channels/909475206190497823/929779478375321622";
}
